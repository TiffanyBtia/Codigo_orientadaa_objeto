...
package com.mycompany.calculadora_tiffany;

/**
 *
 * @author Tiffany Batiz 
 */
public class CalculadorBatiz extends javax.swing.JFrame {
     int num1,num2;
      String signo;
    /**
     * Creates new form CalculadorBatiz
     */
    public CalculadorBatiz() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculadorBatiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculadorBatiz().setVisible(true);
            }
        });
    }
